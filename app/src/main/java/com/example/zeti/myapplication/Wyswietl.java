    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchbox.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                Wyswietl.this.adapter.getFilter().filter(s);
        ...
        list1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent karta = new Intent(getApplicationContext(), KartaPacjenta.class);
                Pacjent p = lista.get((int)id);
                karta.putExtra("pacjent", p);
                startActivity(karta);
            }
        });
        ...
        list1.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                DatabaseManager dbmgr = new DatabaseManager(getApplicationContext(), "database.db", null, 2);
                dbmgr.deletePacjent(lista.get((int)id).getId());
                lista.remove((int)id);
                adapter.notifyDataSetChanged();
                String pen = String.valueOf(id);
                Toast.makeText(getApplicationContext(), "Usunieto: " + " " + pen, Toast.LENGTH_SHORT).show();
